...
# Usage:
# zsh generate_evaluate_iter1.sh [DATASET_NAME] [DATA_SPLIT] [MODEL_NAME] [TEMPERATURE] [TOP_P] [GEN_MODE] [NUM_RETURN_SEQUENCES] [NUM_RETURN_SEQUENCES_AT_TEST_TIME] [NUM_ITERATIONS] [MODEL_CHECKPOINT_FNAME] [MODEL_CHECKPOINT_STEPS] [CROSSMODAL_MODEL] [SAMPLE_SFT_METHOD]
